app.controller('inventoryctrl', function($scope, $http) {
            ...
            if (response.data) {
                ...
                if ($scope.editProduct.length > 0) {
                    for (var i = 0; i < $scope.editProduct.length; i++) {
                        ...
                        arr.id = data.id;
                        arr.supplier = $scope.supplier;
                        arr.user = data.wp_users_id_users;
                        arr.date_time = data.inv_inventory_date;
    ...
    $scope.removeFieldEdit = function(index) {
        $scope.editProduct.remove(index);
    }
