app.controller('recipectctrl', function($scope, $http, dataTableService) {
    ...
    function setDataTableData() {
        ...
        var keys;
        var includes = ['id', 'inv_recipe_cat_name', 'inv_recipe_cat_desc', 'inv_recipe_cat_parent'];

        let parents = [];
        parents.push({
            name: "inv_recipe_cat_parent",
