						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form name="new_user">
									...
									<div class="form-group">
										<label for="name">Unit</label>
										<input type="text" ng-disabled="true" class="form-control" name="name" ng-init="edit_cat.inv_inventory_units_inv_inventory_units_id=1;"
										    ng-model="edit_cat.inv_inventory_units_inv_inventory_units_id" required>
									</div>
